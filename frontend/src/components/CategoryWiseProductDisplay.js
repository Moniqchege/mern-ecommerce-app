            ...
            <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
                {
                    loading ? (
                        ...
                        data.map((product, index) => (
                            <Link to={"/product/" + product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[280px] bg-white rounded-sm shadow ' key={product?._id} onClick={scrollTop}>
